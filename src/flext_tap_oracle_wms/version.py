"""Project metadata for flext tap oracle wms."""
...
class FlextTapOracleWmsVersion(FlextProjectVersion):
    """Structured metadata for the flext tap oracle wms distribution."""
