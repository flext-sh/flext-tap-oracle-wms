...
class ConfigProfileManager:
    ...
    def create_gruponos_profile(self) -> CompanyProfile:
        """Create default GrupoNOS profile based on current usage patterns."""
        # Performance settings optimized for GrupoNOS usage
        performance = PerformanceConfig(
            page_size=1000,  # GrupoNOS uses 1000-record batches
            max_page_size=5000,
        ...
        # API settings for GrupoNOS WMS
        api = APIConfig(
            api_version="v10",
            endpoint_prefix="/wms/lgfapi",
            authentication_method="basic",
            custom_headers={
                "X-Integration-Source": "gruponos-meltano-nativo",
                "X-Data-Source": "WMS-Oracle",
            },
        )

        # GrupoNOS-specific business rules
        ...
        return CompanyProfile(
            company_name="GrupoNOS",
            company_code="GNOS",
            domain="gruponos.com.br",
            environment="prod",
            target_schema="OIC",
            table_prefix="WMS_",
            performance=performance,
...
if __name__ == "__main__":
    ...
    # Create and save GrupoNOS profile
    gruponos_profile = manager.create_gruponos_profile()
    manager.save_profile(gruponos_profile, "gruponos")
    ...
    config = get_singer_config_from_profile("gruponos")
    print("\nSinger config for GrupoNOS:")
