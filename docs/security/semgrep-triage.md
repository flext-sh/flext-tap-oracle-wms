...
```yaml
        1  # Generated by `flext-infra codegen conform` for flext-tap-oracle-wms — DO NOT EDIT.
        2  version: 2
        3  updates:
...
**Classe**: Insecure Configuration · **Local**: `pyproject.toml:624`
...
```toml
      620  all = true
      621  in_place = true
      622  sort_first = ["build-system", "dependency-groups", "project", "tool"]
      623  
>>>   624  [tool.uv]
      625  link-mode = "copy"
      626  
      627  [tool.vulture]
      628  exclude = ["*/_protocols/*"]
```
