# Triagem Semgrep — flext-sh/flext-tap-oracle-wms

Gerado do dump da plataforma Semgrep (deployment `datacosmos`, 2026-08-06).

Bead de rastreio: `mro-p57t.25`
...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 624 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-tap-oracle-wms.json`
