...
class TestWMSBasicAuthenticator:
    ...
    def test_call_caches_auth_headers(self) -> None:
        ...
        request1.headers = {}  # type: ignore[assignment]
        request2 = requests.PreparedRequest()
        request2.headers = {}  # type: ignore[assignment]
    ...
    def test_call_thread_safety(self) -> None:
        ...
        def worker() -> None:
            try:
                request = requests.PreparedRequest()
                request.headers = {}  # type: ignore[assignment]  # type: ignore[assignment]
                result = authenticator(request)
...
class TestGetWMSAuthenticator:
    ...
    def test_get_authenticator_missing_username(self) -> None:
        ...
        with pytest.raises(
            ValueError,
            match="Basic authentication requires username and password",
        ):
    ...
    def test_error_conditions_comprehensive(self) -> None:
        ...
        for invalid_config in invalid_configs:
            with pytest.raises(ValueError, match=".*"):
                get_wms_authenticator(stream, invalid_config)  # type: ignore[arg-type]
