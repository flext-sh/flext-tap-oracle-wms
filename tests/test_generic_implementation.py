...
class TestGenericImplementation:
    ...
    def test_no_client-b_references(self):
        """Test that there are no references to client-b project."""
    ...
    def test_wms_specific_features_preserved(self):
        ...
        assert properties["page_mode"]["allowed_values"] == ["sequenced", "paged"]
    ...
    def test_entity_discovery_is_generic(self):
        ...
        assert discovery.entity_endpoint == "https://wms.example.com/wms/lgfapi/v10/entity/"
