# CLAUDE.local.md - TAP-ORACLE-WMS PROJECT SPECIFICS
...
### **3. Production Integration with gruponos-poc-oic-wms**

**Critical Dependency**: This tap is actively used by gruponos-poc-oic-wms project
...
- **gruponos-poc-oic-wms**: Primary consumer of this tap
...
python scripts/test_gruponos_integration.py               # Test primary consumer
...
- **Connection Changes**: Coordinate with WMS system administrators
...
**Integration**: Primary dependency for gruponos-poc-oic-wms project operations
